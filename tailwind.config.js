  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'km-float-up': { from: { opacity: '0', transform: 'translateY(10px)' }, to: { opacity: '1', transform: 'none' } },
        'km-slide-in-r': { from: { opacity: '0', transform: 'translateX(46px)' }, to: { opacity: '1', transform: 'none' } },
        'km-slide-in-l': { from: { opacity: '0', transform: 'translateX(-46px)' }, to: { opacity: '1', transform: 'none' } },
        'km-bar-grow': { from: { transform: 'scaleX(0)' }, to: { transform: 'scaleX(1)' } },
        'km-v-grow': { from: { transform: 'scaleY(0)' }, to: { transform: 'scaleY(1)' } },
      ...
      animation: {
        ...
        'km-fade': 'km-fade .12s ease both',
        'km-fade-slide': 'km-fade-slide .16s ease both',
        'km-float-up': 'km-float-up .16s ease both',
        'km-slide-in-r': 'km-slide-in-r .3s cubic-bezier(.3,1.1,.4,1) both',
        'km-slide-in-l': 'km-slide-in-l .3s cubic-bezier(.3,1.1,.4,1) both',
        'km-bar-grow': 'km-bar-grow .45s cubic-bezier(.3,1.2,.4,1) both',
        'km-v-grow': 'km-v-grow .45s cubic-bezier(.3,1.2,.4,1) both',
        ...
        'km-hub-pop': 'km-hub-pop .17s cubic-bezier(.2,.9,.3,1.1) both',
        'km-hub-row': 'km-hub-row .2s ease-out both',
