...
- **⚠️ Sauvegardes automatiques Supabase : à vérifier/activer.** Au 20/07/2026, la page Backups du projet indique "Free Plan does not include project backups" — aucune sauvegarde planifiée active constatée, alors que le projet contient déjà des données réelles en cours de bascule. À corriger avant la coupure définitive de Salesforce (upgrade de plan si besoin, ou au minimum un export manuel régulier en attendant).
