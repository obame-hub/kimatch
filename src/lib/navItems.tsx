...
// Mandats, Contrats, Versions, Interactions, Documents et Tâches n'ont pas leur propre
// entrée : on les retrouve toujours via un Site, un Compte, un Contact ou un Compteur (et,
// pour les tâches, sur le Tableau de bord — "mes tâches du jour"), jamais dans une liste
// isolée (retour William) — leurs pages/routes restent accessibles en navigation profonde,
// seul le lien de premier niveau est retiré.
