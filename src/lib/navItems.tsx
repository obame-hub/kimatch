...
export const navItems = [
  { to: '/', label: 'Tableau de bord', icon: LayoutDashboard, end: true, accent: 'bg-ink-700', tint: 'text-navy-300' },
  ...
  { to: '/recommandations', label: 'Recommandations', icon: FileText, accent: 'bg-amber-500', tint: 'text-amber-300' },
