...
export const mockSignaux: Signal[] = [
  { id: 'sig1', site_id: 's1', site_nom: 'Résidence Les Tilleuls', type_signal: 'Échéance de contrat', statut: 'A_CONTACTER', conseiller: 'Naoëlle Ghouma', date_creation: '2026-07-10', description: 'Contrat électricité parties communes arrivant à échéance dans 45 jours.', proprietaire_id: null },
  { id: 'sig2', site_id: 's2', site_nom: 'Siège social — Paris', type_signal: 'Opportunité fournisseur', statut: 'INTERET_CONFIRME', conseiller: 'William Goupil', date_creation: '2026-07-08', description: 'Nouvelle offre marché plus compétitive détectée sur le segment tertiaire.', proprietaire_id: null },
  { id: 'sig3', site_id: 's5', site_nom: 'Résidence Le Parc', type_signal: 'Nouvelle facture', statut: 'NOUVEAU', conseiller: 'Naoëlle Ghouma', date_creation: '2026-07-14', description: 'Hausse de consommation inhabituelle détectée sur le compteur chaufferie.', proprietaire_id: null },
  { id: 'sig4', site_id: 's4', site_nom: 'Hôtel Belvédère', type_signal: 'Demande du client', statut: 'CONTACTE', conseiller: 'William Goupil', date_creation: '2026-07-12', description: 'Le directeur de site demande un audit énergétique complet.', proprietaire_id: null },
  { id: 'sig5', site_id: 's1', site_nom: 'Résidence Les Tilleuls', type_signal: 'Préavis', statut: 'A_CONTACTER', conseiller: 'Naoëlle Ghouma', date_creation: '2026-07-15', description: 'Période de préavis ouverte sur le contrat gaz chaufferie.', proprietaire_id: null },
]
...
export const mockActions: ActionItem[] = [
  { id: 'a1', titre: 'Contacter le client', type_action: 'Appel', statut: 'A_FAIRE', priorite: 50, responsable: 'Naoëlle Ghouma', echeance: '2026-07-17', date_realisation: null, commentaire: null, cible_label: 'Résidence Les Tilleuls', site_id: 's1', contact_id: 'ct1', contact_nom: 'Marc Lefebvre', proprietaire_id: null },
  { id: 'a2', titre: 'Préparer le mandat', type_action: 'Administratif', statut: 'A_FAIRE', priorite: 40, responsable: 'William Goupil', echeance: '2026-07-18', date_realisation: null, commentaire: null, cible_label: 'Hôtel Belvédère', site_id: 's4', contact_id: 'ct3', contact_nom: 'Antoine Perez', proprietaire_id: null },
  { id: 'a3', titre: 'Présenter la recommandation', type_action: 'Présentation', statut: 'EN_COURS', priorite: 60, responsable: 'William Goupil', echeance: '2026-07-16', date_realisation: null, commentaire: null, cible_label: 'Siège social — Paris', site_id: 's2', contact_id: 'ct2', contact_nom: 'Sophie Nguyen', proprietaire_id: null },
  { id: 'a4', titre: 'Relancer le client', type_action: 'Relance', statut: 'A_FAIRE', priorite: 30, responsable: 'Naoëlle Ghouma', echeance: '2026-07-20', date_realisation: null, commentaire: null, cible_label: 'Résidence Le Parc', site_id: 's5', contact_id: null, contact_nom: '', proprietaire_id: null },
]
...
export const mockMandats: Mandat[] = [
  { id: 'm1', compte_id: 'c1', compte_nom: 'Cabinet Durand', statut: 'ACTIF', date_signature: '2026-05-02', nb_sites_couverts: 2, site_ids: ['s1', 's5'], contact_signataire_id: 'ct1', contact_signataire_nom: 'Marc Lefebvre', proprietaire_id: null },
  { id: 'm2', compte_id: 'c2', compte_nom: 'Groupe Meridia', statut: 'ACTIF', date_signature: '2026-03-14', nb_sites_couverts: 2, site_ids: ['s2', 's3'], contact_signataire_id: 'ct2', contact_signataire_nom: 'Sophie Nguyen', proprietaire_id: null },
  { id: 'm3', compte_id: 'c3', compte_nom: 'Hôtellerie du Sud', statut: 'EN_SIGNATURE', date_signature: null, nb_sites_couverts: 1, site_ids: ['s4'], proprietaire_id: null },
]

export const mockContacts: Contact[] = [
  { id: 'ct1', compte_id: 'c1', compte_nom: 'Cabinet Durand', civilite: 'M.', prenom: 'Marc', nom: 'Lefebvre', fonction: 'Syndic', telephone: '01 23 45 67 89', email: 'marc.lefebvre@cabinet-durand.fr', contact_principal: true, actif: true, sites: [{ id: 's1', nom: 'Résidence Les Tilleuls', fonction_sur_site: 'Contact principal' }], proprietaire_id: null },
  { id: 'ct2', compte_id: 'c2', compte_nom: 'Groupe Meridia', civilite: 'Mme', prenom: 'Sophie', nom: 'Nguyen', fonction: 'Directrice des achats', telephone: '01 98 76 54 32', email: 's.nguyen@meridia.fr', contact_principal: true, actif: true, sites: [{ id: 's2', nom: 'Siège social — Paris', fonction_sur_site: null }], proprietaire_id: null },
  { id: 'ct3', compte_id: 'c3', compte_nom: 'Hôtellerie du Sud', civilite: 'M.', prenom: 'Antoine', nom: 'Perez', fonction: 'Directeur technique', telephone: '04 91 22 33 44', email: 'a.perez@hotellerie-sud.fr', contact_principal: false, actif: true, sites: [{ id: 's4', nom: 'Hôtel Belvédère', fonction_sur_site: 'Contact site' }], proprietaire_id: null },
]
...
export const mockComptes: Compte[] = [
  { id: 'c1', nom: 'Cabinet Durand', type_compte: 'client', segment: 'Syndic', nb_sites: 2, ville: 'Lyon', siren: '123456789', score_ellipro: null, score_ellipro_scale: null, score_ellipro_maj: null, segment_compte_libelle: 'Grand compte', conseiller_referent_nom: 'Naoëlle Ghouma', origine_acquisition: 'Recommandation', mandat_cadre_actif: true, proprietaire_id: null },
  { id: 'c2', nom: 'Groupe Meridia', type_compte: 'client', segment: 'Entreprise', nb_sites: 2, ville: 'Paris', siren: '234567891', score_ellipro: null, score_ellipro_scale: null, score_ellipro_maj: null, proprietaire_id: null },
  { id: 'c3', nom: 'Hôtellerie du Sud', type_compte: 'client', segment: 'Hôtellerie', nb_sites: 1, ville: 'Marseille', siren: '345678912', score_ellipro: null, score_ellipro_scale: null, score_ellipro_maj: null, proprietaire_id: null },
  { id: 'c4', nom: 'Retail Plus', type_compte: 'client', segment: 'Commerce', nb_sites: 1, ville: 'Bordeaux', siren: '456789123', score_ellipro: null, score_ellipro_scale: null, score_ellipro_maj: null, proprietaire_id: null },
  { id: 'c5', nom: 'EDF', type_compte: 'fournisseur', segment: 'Fournisseur historique', nb_sites: 0, ville: 'Paris', siren: '552081317', score_ellipro: null, score_ellipro_scale: null, score_ellipro_maj: null, fournit_electricite: true, fournit_gaz: false, statut_partenariat: 'ACTIF', proprietaire_id: null },
  { id: 'c6', nom: 'ENGIE', type_compte: 'fournisseur', segment: 'Fournisseur', nb_sites: 0, ville: 'Courbevoie', siren: '542107651', score_ellipro: null, score_ellipro_scale: null, score_ellipro_maj: null, fournit_electricite: false, fournit_gaz: true, statut_partenariat: 'ACTIF', proprietaire_id: null },
...
export const mockCompteurs: Compteur[] = [
  { id: 'cp1', site_id: 's1', site_nom: 'Résidence Les Tilleuls', type_energie: 'electricite', numero_pdl: 'PDL-30001245', utilisation: 'Parties communes', statut: 'actif', consommation_annuelle_mwh: 12.4, synchro_eneo: true, date_derniere_synchro_eneo: '2026-07-10T09:00:00', segment: 'C5', tension: 'BT', tarif_distribution: 'BTINFCU4', proprietaire_id: null },
  { id: 'cp2', site_id: 's1', site_nom: 'Résidence Les Tilleuls', type_energie: 'gaz', numero_pdl: 'GRD-88213456', utilisation: 'Chaufferie', statut: 'actif', consommation_annuelle_mwh: 34.8, synchro_eneo: false, date_derniere_synchro_eneo: null, car_mwh: 34.8, profil_consommation: 'P011', zone_tarifaire: 'Zone B', proprietaire_id: null },
  { id: 'cp3', site_id: 's2', site_nom: 'Siège social — Paris', type_energie: 'electricite', numero_pdl: 'PDL-30009981', utilisation: 'Bureaux', statut: 'actif', consommation_annuelle_mwh: 68.8, synchro_eneo: true, date_derniere_synchro_eneo: '2026-07-15T14:20:00', segment: 'C4', tension: 'BT', tarif_distribution: 'BTSUPCU4', proprietaire_id: null },
  { id: 'cp4', site_id: 's3', site_nom: 'Entrepôt Nord', type_energie: 'electricite', numero_pdl: 'PDL-30012783', utilisation: 'Entrepôt principal', statut: 'actif', consommation_annuelle_mwh: null, synchro_eneo: false, date_derniere_synchro_eneo: null, proprietaire_id: null },
  { id: 'cp5', site_id: 's4', site_nom: 'Hôtel Belvédère', type_energie: 'gaz', numero_pdl: 'GRD-88245901', utilisation: 'Cuisine + chaufferie', statut: 'actif', consommation_annuelle_mwh: null, synchro_eneo: false, date_derniere_synchro_eneo: null, proprietaire_id: null },
  { id: 'cp6', site_id: 's5', site_nom: 'Résidence Le Parc', type_energie: 'electricite', numero_pdl: 'PDL-30015567', utilisation: 'Ascenseurs', statut: 'actif', consommation_annuelle_mwh: null, synchro_eneo: false, date_derniere_synchro_eneo: null, proprietaire_id: null },
]
...
export const mockContrats: Contrat[] = [
  { id: 'cn1', site_id: 's1', site_nom: 'Résidence Les Tilleuls', fournisseur_compte_id: 'c5', fournisseur_nom: 'EDF', type_energie: 'electricite', reference_fournisseur: 'EDF-778124', date_debut: '2024-09-01', date_fin: '2026-08-31', statut: 'ACTIF', compteurs: [{ id: 'cp1', numero_pdl: 'PDL-30001245', utilisation: 'Parties communes' }], proprietaire_id: null },
  { id: 'cn2', site_id: 's1', site_nom: 'Résidence Les Tilleuls', fournisseur_compte_id: 'c6', fournisseur_nom: 'ENGIE', type_energie: 'gaz', reference_fournisseur: 'ENG-33291', date_debut: '2023-11-01', date_fin: '2026-10-31', statut: 'ACTIF', compteurs: [{ id: 'cp2', numero_pdl: 'GRD-88213456', utilisation: 'Chaufferie' }], proprietaire_id: null },
  { id: 'cn3', site_id: 's2', site_nom: 'Siège social — Paris', fournisseur_compte_id: 'c5', fournisseur_nom: 'EDF', type_energie: 'electricite', reference_fournisseur: 'EDF-445982', date_debut: '2025-01-01', date_fin: '2026-12-31', statut: 'ACTIF', compteurs: [{ id: 'cp3', numero_pdl: 'PDL-30009981', utilisation: 'Bureaux' }], proprietaire_id: null },
]
