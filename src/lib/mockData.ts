    ...
    versions: [
      {
        ...
        optimisations: [
          {
            id: 'opt1', nom: 'Mise en concurrence 24 mois', type_optimisation: 'Renégociation', type_optimisation_code: 'MISE_EN_CONCURRENCE',
            ...
            fournisseurs_consultes: [
              { id: 'fc1', fournisseur_compte_id: 'c5', fournisseur_nom: 'EDF', date_creation: '2026-07-01', statut_actuel: 'Réponse reçue', historique: [
                { id: 'sc1', statut: 'Demande envoyée', date_evenement: '2026-07-01', commentaire: null, auteur_nom: 'Naoëlle Ghouma' },
                { id: 'sc2', statut: 'Réponse reçue', date_evenement: '2026-07-08', commentaire: null, auteur_nom: 'Naoëlle Ghouma' },
              ] },
              { id: 'fc2', fournisseur_compte_id: 'c6', fournisseur_nom: 'ENGIE', date_creation: '2026-07-01', statut_actuel: 'Réponse reçue', historique: [
                { id: 'sc3', statut: 'Demande envoyée', date_evenement: '2026-07-01', commentaire: null, auteur_nom: 'Naoëlle Ghouma' },
                { id: 'sc4', statut: 'Réponse reçue', date_evenement: '2026-07-10', commentaire: null, auteur_nom: 'Naoëlle Ghouma' },
              ] },
            ],
          },
        ],
...
export const mockMandats: Mandat[] = [
  { id: 'm1', compte_id: 'c1', compte_nom: 'Cabinet Durand', statut: 'ACTIF', date_signature: '2026-05-02', date_envoi: '2026-04-28', date_debut_validite: '2026-05-02', date_fin_validite: '2028-05-02', nb_sites_couverts: 2, site_ids: ['s1', 's5'], compteur_ids: ['cp1', 'cp2', 'cp6'], contact_signataire_id: 'ct1', contact_signataire_nom: 'Marc Lefebvre', proprietaire_id: null, courtier_codes: ['KIWI', 'ENERGIX'] },
  { id: 'm2', compte_id: 'c2', compte_nom: 'Groupe Meridia', statut: 'ACTIF', date_signature: '2026-03-14', date_envoi: '2026-03-10', date_debut_validite: '2026-03-14', date_fin_validite: '2028-03-14', nb_sites_couverts: 2, site_ids: ['s2', 's3'], compteur_ids: ['cp3', 'cp4'], contact_signataire_id: 'ct2', contact_signataire_nom: 'Sophie Nguyen', proprietaire_id: null, courtier_codes: ['KIWI'] },
  { id: 'm3', compte_id: 'c3', compte_nom: 'Hôtellerie du Sud', statut: 'EN_SIGNATURE', date_signature: null, date_envoi: '2026-07-10', date_debut_validite: null, date_fin_validite: null, nb_sites_couverts: 1, site_ids: ['s4'], compteur_ids: ['cp5'], proprietaire_id: null, courtier_codes: ['KIWI', 'ENERGIX'] },
]
...
export const mockContrats: Contrat[] = [
  { id: 'cn1', compte_id: 'c1', site_id: 's1', site_nom: 'Résidence Les Tilleuls', fournisseur_compte_id: 'c5', fournisseur_nom: 'EDF', type_energie: 'electricite', reference_fournisseur: 'EDF-778124', date_debut: '2024-09-01', date_fin: '2026-08-31', preavis_resiliation_jours: 90, statut: 'ACTIF', compteurs: [{ id: 'cp1', contrat_compteur_id: null, numero_pdl: 'PDL-30001245', utilisation: 'Parties communes' }], proprietaire_id: null, docusign_envelope_id: null, date_envoi_signature: null, date_signature: null, statut_signature: null },
  { id: 'cn2', compte_id: 'c1', site_id: 's1', site_nom: 'Résidence Les Tilleuls', fournisseur_compte_id: 'c6', fournisseur_nom: 'ENGIE', type_energie: 'gaz', reference_fournisseur: 'ENG-33291', date_debut: '2023-11-01', date_fin: '2026-10-31', preavis_resiliation_jours: 90, statut: 'ACTIF', compteurs: [{ id: 'cp2', contrat_compteur_id: null, numero_pdl: 'GRD-88213456', utilisation: 'Chaufferie' }], proprietaire_id: null, docusign_envelope_id: null, date_envoi_signature: null, date_signature: null, statut_signature: null },
  { id: 'cn3', compte_id: 'c2', site_id: 's2', site_nom: 'Siège social — Paris', fournisseur_compte_id: 'c5', fournisseur_nom: 'EDF', type_energie: 'electricite', reference_fournisseur: 'EDF-445982', date_debut: '2025-01-01', date_fin: '2026-12-31', preavis_resiliation_jours: 90, statut: 'ACTIF', compteurs: [{ id: 'cp3', contrat_compteur_id: null, numero_pdl: 'PDL-30009981', utilisation: 'Bureaux' }], proprietaire_id: null, docusign_envelope_id: null, date_envoi_signature: null, date_signature: null, statut_signature: null },
]
