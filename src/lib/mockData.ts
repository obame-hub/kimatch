...
export const mockSites: Site[] = [
  { id: 's1', nom: 'Résidence Les Tilleuls', compte_id: 'c1', compte_nom: 'Cabinet Durand', type_site: 'Copropriété', adresse: '12 rue Garibaldi', ville: 'Lyon', code_postal: '69003', latitude: 45.7610, longitude: 4.8605, annee_construction: 1978, surface_m2: 3200, date_derniere_ag: '2026-06-24', nb_compteurs: 4, nb_signaux_ouverts: 2, statut: 'actif' },
  { id: 's2', nom: 'Siège social — Paris', compte_id: 'c2', compte_nom: 'Groupe Meridia', type_site: 'Immeuble tertiaire', adresse: '48 avenue Franklin Roosevelt', ville: 'Paris', code_postal: '75008', latitude: 48.8698, longitude: 2.3079, annee_construction: 1995, surface_m2: 5400, date_derniere_ag: null, nb_compteurs: 2, nb_signaux_ouverts: 1, statut: 'actif' },
  { id: 's3', nom: 'Entrepôt Nord', compte_id: 'c2', compte_nom: 'Groupe Meridia', type_site: 'Entrepôt', adresse: '', ville: 'Lille', code_postal: '59000', latitude: null, longitude: null, annee_construction: null, surface_m2: null, date_derniere_ag: null, nb_compteurs: 3, nb_signaux_ouverts: 0, statut: 'actif' },
  { id: 's4', nom: 'Hôtel Belvédère', compte_id: 'c3', compte_nom: 'Hôtellerie du Sud', type_site: 'Hôtel', adresse: '5 corniche Kennedy', ville: 'Marseille', code_postal: '13001', latitude: 43.2871, longitude: 5.3556, annee_construction: 1962, surface_m2: 4100, date_derniere_ag: null, nb_compteurs: 5, nb_signaux_ouverts: 1, statut: 'actif' },
  { id: 's5', nom: 'Résidence Le Parc', compte_id: 'c1', compte_nom: 'Cabinet Durand', type_site: 'Copropriété', adresse: '3 rue Vendôme', ville: 'Lyon', code_postal: '69006', latitude: 45.7692, longitude: 4.8511, annee_construction: 1985, surface_m2: 2100, date_derniere_ag: '2026-04-02', nb_compteurs: 2, nb_signaux_ouverts: 3, statut: 'actif' },
  { id: 's6', nom: 'Magasin Centre-ville', compte_id: 'c4', compte_nom: 'Retail Plus', type_site: 'Commerce', adresse: '', ville: 'Bordeaux', code_postal: '33000', latitude: null, longitude: null, annee_construction: null, surface_m2: null, date_derniere_ag: null, nb_compteurs: 1, nb_signaux_ouverts: 0, statut: 'actif' },
]
...
export const mockSignaux: Signal[] = [
  { id: 'sig1', site_id: 's1', site_nom: 'Résidence Les Tilleuls', type_signal: 'Échéance de contrat', statut: 'A_CONTACTER', conseiller: 'Naoëlle Ghouma', date_creation: '2026-07-10', description: 'Contrat électricité parties communes arrivant à échéance dans 45 jours.' },
  { id: 'sig2', site_id: 's2', site_nom: 'Siège social — Paris', type_signal: 'Opportunité fournisseur', statut: 'INTERET_CONFIRME', conseiller: 'William Goupil', date_creation: '2026-07-08', description: 'Nouvelle offre marché plus compétitive détectée sur le segment tertiaire.' },
  { id: 'sig3', site_id: 's5', site_nom: 'Résidence Le Parc', type_signal: 'Nouvelle facture', statut: 'NOUVEAU', conseiller: 'Naoëlle Ghouma', date_creation: '2026-07-14', description: 'Hausse de consommation inhabituelle détectée sur le compteur chaufferie.' },
  { id: 'sig4', site_id: 's4', site_nom: 'Hôtel Belvédère', type_signal: 'Demande du client', statut: 'CONTACTE', conseiller: 'William Goupil', date_creation: '2026-07-12', description: 'Le directeur de site demande un audit énergétique complet.' },
  { id: 'sig5', site_id: 's1', site_nom: 'Résidence Les Tilleuls', type_signal: 'Préavis', statut: 'A_CONTACTER', conseiller: 'Naoëlle Ghouma', date_creation: '2026-07-15', description: 'Période de préavis ouverte sur le contrat gaz chaufferie.' },
]
